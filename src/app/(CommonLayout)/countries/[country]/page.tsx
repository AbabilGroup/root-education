          ...
          <div className="basis-[60%] space-y-4">
            ...
            <div className="space-y-3">
              <p className="text-sm font-medium">
                ...
                Romania offers a wide range of programs in English across
                various fields, including engineering, medicine, business, and
                the arts. Universities in Romania are recognized for their
                rigorous curricula, modern facilities, and opportunities for
                research and innovation.
              </p>
              <p className="text-sm font-medium">
                For Bangladeshi students, Romania provides a welcoming
                ...
                student support services, making the transition to a new
                academic and social environment smoother. Scholarships are also
                available to help offset tuition fees and living expenses,
                making studying in Romania even more accessible.
              </p>
              <p className="text-sm font-medium">
                For Bangladeshi students, Romania provides a welcoming
                environment with a rich cultural heritage, vibrant student life,
            ...
            <div className="flex items-start justify-start gap-x-6">
              <div className="space-y-3">
                <div className="flex items-center justify-start gap-x-2">
                  ...
                  <h6 className="font-semibold">Why Study in Romania?</h6>
                </div>
                <div className="flex items-center justify-start gap-x-2">
                  <svg
                    width="18"
